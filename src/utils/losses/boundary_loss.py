...
class BoundaryLoss(nn.Module):
    """Lightweight boundary-aware loss.

    Computes image gradients on prediction probabilities and target masks
    using Sobel filters and minimizes their L1 difference.
    """
    def __init__(self):
        super().__init__()
